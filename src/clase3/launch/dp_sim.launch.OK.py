...
def generate_launch_description():
    ...
    #            [FindPackageShare('clase3'),
    #             'urdf', 'double_pendulum.urdf']
    #        ),
    #    ]
    #)
    
    # Obtener la ruta al URDF
    urdf_path = os.path.join(
        FindPackageShare('clase3').find('clase3'),
        'urdf', 'double_pendulum.urdf'
    )
    ...
    robot_controllers = os.path.join(get_package_share_directory('clase3'),'config', 'ros2_controllers.yaml')
